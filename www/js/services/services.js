...
angular
  ...
  .service('dolarServiceOld', function() {
      ...
      this.initDolar = function () {
        $http.get('https://dolarhoyapi.herokuapp.com/dolar/Hola123!')
...
angular
  ...
  .factory('dolarFactory', function($http) {
      return $http
          .get('https://dolarhoyapi.herokuapp.com/dolar/Hola123!')
          .success(function (data) {
...
angular
  ...
  .service('dolarService', function($q, $compile, $http) {
    this.getData = function() {
      var promise = $http.get('https://dolarhoyapi.herokuapp.com/dolar/Hola123!');
